...
export const flowMaeEcoPopuProcCom = addKeyword(['07']).addAnswer([
    '📄 *Maestría en Economía Popular y Procesos Comunitario*',
    ...
    '\n*Eje 3: Ciclo metodológico*',
    'Métodos cuantitativos y cualitativos (Dra. Laura Golovanevsky y Dra. Agustina Romero)',
    'Seminario de Tesis (Dra. Natividad González, Dra. María Rosa Chachagua, Dra. Agustina Romero y Mg. Luciana Barconte)',


    '\nPara más info, visitanos en: https://www.fhycs.unju.edu.ar/secretaria_posgrado/posgrado_articulo.php?id=105',
]).addAnswer([
...
.addAnswer(`Más info en el archivo PDF`, {
    media: join(process.cwd(), 'assets', '7MaeEcoPopuProcCom.pdf')
})